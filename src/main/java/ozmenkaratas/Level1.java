...
public class Level1 extends javax.swing.JFrame {
    ...
    public Level1(String name) {
        ...
        for (int i = 0; i < 35; i++) {
            if ("treasure".equals(temp.data.durumları)) {
                A[i].setIcon(new ImageIcon(image1));
            } else if ("trap".equals(temp.data.durumları)) {
    ...
    private void btnRollActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRollActionPerformed
        ...
        int x = (int) ((Math.random() * 6) + 1);// 1-6 arası sayı tutacak
        ...
        if (step > 35) {
            ...
            for (int i = 0; i < 35; i++) {
                if ("treasure".equals(temp.data.durumları)) {
                    ...
                    A[i].setIcon(new ImageIcon(image2));
                } else if ("empty".equals(temp.data.durumları)) {
